...
<link href="deletecocurricular.css" rel="stylesheet"></link>
...
$link=mysqli_connect("localhost","root","","it");
            ...
            <?php
             ...
             echo "<td><a href='deletecir.php?tab=$tab&id=$c_name'><i class='fa fa-trash' style='font-size:40px;color:red'></i></td>";
             ...
             echo "</tr>";
              ...
              echo "<h1 align='center'>Co-Curriular Activities</h1><br>";
