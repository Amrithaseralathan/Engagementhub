...
<div class="wrapper">
  <button name="ca" onclick="window.open('delcocur.php','_self')">Co-Curricular activity
    <span></span>
    <span></span>
    <span></span>
    <span></span>
...
&nbsp 
<div class="rapper">
  <button name="ex"  onclick="window.open('delextra.php','_self')">Extra-curricular activity
    <span></span>
    <span></span>
    <span></span>
    <span></span>
