...
<h2></h2>
<br>
<h2>Add Extra-Curricular Activity</h3><br><br>
<div class="box">
...
<td>
<input required type="file" id="files" name="files"><br><h6 style="font-family: arial;color: red">(.jpg .jpeg .jfif .png)</h6>
</td>
</tr>
<tr>
...
$sql=mysqli_query($link,"SELECT * FROM extracur WHERE cid='$cid'");
$c=mysqli_num_rows($sql);
if($c==0){
  $query="INSERT into extracur(c_name,org,s_p,e_p,cid,file,fname,reg,time) VALUES ('$cn','$or','$sp','$ep','$cid','$imgContent','$im_m','$reg',NOW())";
