      ...
      <div class="col-lg-8">
        ...
        <div class="card shadow-sm">
          <div class="card-header bg-transparent border-0">
           ...
           <td><iframe src="data:application/pdf;charset=utf8;base64,<?php echo base64_encode($row['file']); ?>"width=300px height=200px></td><?php
            ...
            echo"</table><br><button><a href='option.php'>Upload</a></button><button><a href='optiond.php'>Delete</a></button>";
}
else{?>
  <nav>
     
      <label class="logo"><img src="icon.png" height="50" width="50" style="vertical-align:middle"> IT Activities</label>
      <ul>
        <li><a  href="home.html">Home</a></li>
        <li><a   href="co-curricular.html">Co-curricular</a></li>
        <li><a  href="extracurricular.html">Extra curricular</a></li>
